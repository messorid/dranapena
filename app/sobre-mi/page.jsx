...
export const metadata = {
  ...
  description: "Conoce a la Dra. Ana Maria Peña, médico cirujano especialista en Otorrinolaringología. Atención clínica y quirúrgica especializada para enfermedades del oído, nariz y garganta.",
  ...
  openGraph: {
    ...
    description: "Atención clínica y quirúrgica especializada para enfermedades del oído, nariz y garganta en Barinas y Caracas.",
