        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-16">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-4 text-sm w-full max-w-[250px]">
              ...
              {/* Teléfono / WhatsApp */}
              <li>
                <a href="https://wa.me/584140731821" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center md:justify-start gap-3 group">
                  ...
                  <span className="text-slate-400 group-hover:text-white transition-colors">+58 414-0731821</span>
                </a>
              </li>
              ...
              {/* Instagram */}
              <li>
                <a href="https://instagram.com/otorrinoana" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center md:justify-start gap-3 group">
                  ...
                  <span className="text-slate-400 group-hover:text-white transition-colors">@otorrinoana</span>
                </a>
              </li>
